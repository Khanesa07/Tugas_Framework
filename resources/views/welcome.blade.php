        ...
        <div class="container mx-auto px-2 tm-intro-width">
            <div class="sm:pb-60 sm:pt-48 py-20">
                <div class="bg-black bg-opacity-70 p-12 mb-5 text-center">
                    <h1 class="text-white text-5xl tm-logo-font mb-5">Tique Cafe</h1>
                    <p class="tm-text-gold tm-text-2xl">Membuat Pagi Anda Yang Berbahagia</p>
                </div>    
                <div class="bg-black bg-opacity-70 p-10 mb-5">
                    <p class="text-white leading-8 text-sm font-light">
                        Cafe kami menyediakan berbagai macam kopi-kopi nusantara dan kopi eropa,kopi kami asli dari dalam negeri dan luar negeri.
                    	Jika kamu ingin bertanya, please <a rel="nofollow" href="https://www.tooplate.com/contact" target="_parent">hubungi no yang tertera</a>. </p>
                </div>
                ...
                <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                    <div class="flex items-start mb-6 tm-menu-item">
                        ...
                        <div class="ml-3 sm:ml-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">S $21.000</div>
                            <div class="text-white text-md sm:text-lg font-light">L $41.000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        ...
                        <div class="ml-3 sm:ml-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">S $20.000</div>
                            <div class="text-white text-md sm:text-lg font-light">L $30.000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        ...
                        <div class="ml-3 sm:ml-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">M $15.000</div>
                            <div class="text-white text-md sm:text-lg font-light">L $25.000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        ...
                        <div class="ml-3 sm:ml-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light">Size M $17.000 . L $32.000</div>
                        </div>                    
                    </div>
                </div>
                <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">Small $12.000</div>
                            <div class="text-white text-md sm:text-lg font-light">Large $17.000</div>
                        </div>
                    ...
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">Small $13.000</div>
                            <div class="text-white text-md sm:text-lg font-light">Large $21.000</div>
                        </div>
                    ...
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">Small $16.000</div>
                            <div class="text-white text-md sm:text-lg font-light">Large $24.000</div>
                        </div>   
                    ...
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">                    
                        <div class="text-right mr-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light">Small $10.000 . Large $15.000</div>
                        </div> 
            ...
            <div class="tm-item-container sm:ml-auto sm:mr-12 mx-auto sm:px-0 px-4">
                <div class="bg-white bg-opacity-80 p-12 pb-14 rounded-xl mb-5">
                    ...
                    <p class="mb-6 text-base leading-8">
                        Cafe kami Menyediakan Barang-Barang Premium.
                  </p>
                    <p class="text-base leading-8">
                        Jika kamu berkenan <a rel="nofollow" href="https://www.tooplate.com/contact" target="_parent">support us</a>, tolong donasi ke play pal. Thank you. </p>
                </div>
        ...
        <div class="container mx-auto tm-container pt-24 pb-48 sm:py-48">
            <div class="flex flex-col lg:flex-row justify-around items-center lg:items-stretch">
                <div class="flex-1 rounded-xl px-10 py-12 m-5 bg-white bg-opacity-80 tm-item-container">
                    ...
                    <p class="mb-10 text-lg">
                        <span class="block mb-2">Tel: <a href="tel:0896-4706-6667" class="hover:text-yellow-600 transition">0896-4706-6667</a></span>
                        <span class="block">Email: <a href="13khanesa66@gamil.com" class="hover:text-yellow-600 transition">13khanesa666@gmail.com</a></span>                        
                    </p>
                    <div class="text-center">
            ...
            <footer class="absolute bottom-0 left-0 w-full">
                <div class="text-white container mx-auto tm-container p-8 text-lg flex flex-col md:flex-row justify-between">
                    <span>Copyright 2022 By FADIL. All rights reserved.</span>
                    <span class="mt-5 md:mt-0"> <a href="https://www.tooplate.com" target="_parent"></a></span>
                </div>                
            </footer>
        </div>        
    </div>    
